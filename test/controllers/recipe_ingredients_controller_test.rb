...
class RecipeIngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipe_ingredient" do
    assert_difference('RecipeIngredient.count') do
      post recipe_ingredients_url, params: { recipe_ingredient: { amount: @recipe_ingredient.amount, belongs_to: @recipe_ingredient.belongs_to } }
    end
  ...
  test "should update recipe_ingredient" do
    patch recipe_ingredient_url(@recipe_ingredient), params: { recipe_ingredient: { amount: @recipe_ingredient.amount, belongs_to: @recipe_ingredient.belongs_to } }
